...
# 🔁 CHECKPOINT — SWAP SUBJECT/GRADE: Change this list of PDFs
PDF_PATHS = [
...
def build_retriever():
    ...
    # --- First run: load all chapter PDFs ---
    raw_pages = []
    for pdf in PDF_PATHS:
        ...
        raw_pages.extend(loader.load())        # accumulate pages from all chapters
